...
export default function FearHistoryChart() {
  ...
  const CustomTooltip = ({ active, payload }) => {
    if (active && payload && payload.length) {
      ...
      return (
        <div style={{ backgroundColor: 'var(--bg-elevated)', padding: '12px', border: '1px solid var(--border-default)', borderRadius: '8px' }}>
  ...
  return (
    <div style={{ width: '100%', height: '300px', padding: '24px', backgroundColor: 'var(--bg-secondary)', borderRadius: '16px', border: '1px solid var(--border-subtle)' }}>
